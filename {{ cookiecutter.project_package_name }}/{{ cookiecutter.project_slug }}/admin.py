...
from {{ cookiecutter.project_slug }} import models, forms

def is_versioning_enabled():
    return True

@admin.register(models.{{ cookiecutter.project_config_class }})
class {{ cookiecutter.project_config_class }}Admin(admin.ModelAdmin):
    pass


@admin.register(models.{{ cookiecutter.project_class }}Content)
class {{ cookiecutter.project_class }}ContentAdmin(admin.ModelAdmin):
    form = forms.{{ cookiecutter.project_class }}ContentForm
    ...
    def delete_view(self, request, object_id, extra_context=None):
        ...
        if request.POST and not protected:  # The user has confirmed the deletion.
            ...
            return HttpResponseRedirect(admin_reverse('{{ cookiecutter.project_slug }}_{{ cookiecutter.project_class.lower() }}content_changelist') + '?' + query)
